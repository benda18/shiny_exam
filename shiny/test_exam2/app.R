...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(width = 4,
                 wellPanel(fluidRow(
                   strong("Display hashing function")
                 ),),
                 wellPanel(fluidRow(
                   strong("Display hash output")
                 ),)),
    ...
    mainPanel(width = 8,
              wellPanel(
                tabsetPanel(
                  id = NULL, selected = NULL, type = "pills", header = NULL,footer = NULL,
                  ...
                  # PANEL: Tab Evaluation----
                  tabPanel(title = "Exam Evaluation",),
                  
                  # PANEL: Tab hold for future use----
                  tabPanel(title = "<hold>",),
                ),
              ),
    )
